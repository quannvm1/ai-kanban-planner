...
export function PomodoroWidget({ task, onClose, onFinished }: PomodoroWidgetProps) {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 animate-in slide-in-from-bottom-5 duration-300">
      <div className="rounded-2xl bg-slate-900/95 border border-indigo-500/50 p-4 shadow-2xl backdrop-blur-xl w-80 space-y-3">
        ...
        <div className="text-center py-2">
          <span className="text-4xl font-extrabold tracking-tight font-mono bg-gradient-to-r from-indigo-400 to-cyan-400 bg-clip-text text-transparent">
        ...
        <div className="flex items-center justify-center gap-2">
          <button
            ...
            className="px-4 py-2 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white font-semibold text-xs flex items-center gap-1.5 shadow-md shadow-indigo-600/30"
          >
