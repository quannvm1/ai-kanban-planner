...
import { ListTodo, CheckSquare, Clock, Calendar, Star } from 'lucide-react';
  ...
  return (
    <div className="p-6 space-y-4 max-h-[calc(100vh-120px)] overflow-y-auto">
      <div>
        ...
        <p className="text-xs text-slate-500 dark:text-slate-400">Xem toàn bộ công việc theo dạng bảng danh sách tổng quan</p>
      </div>
